...
localStorage.setItem("hasData","true");
      ...
      function startQuestion() {
        ...
        //     var userIdToLocalStorage2=JSON.parse(userIdToLocalStorage);
        //     if (userIdToLocalStorage2==userId) {
        //        alert(userIdToLocalStorage2);
        //     }else{
    ...
    //user ID authontication
        if (true) {
            ...
            if (userIdToLocalStorage2==userId) {
              ...
              window.location.replace("index.html?error="+errorMessage);
            }
...
//after submit result insert storage
    
    function dataStoreAfterSubmit() {
            ...
            var currentQuestionParse=JSON.parse(userIdToLocalStorage);
            var solutionData = _.find(currentQuestionParse,{id,subjectId,answerStatus,score,viewTime,reviewTime});
